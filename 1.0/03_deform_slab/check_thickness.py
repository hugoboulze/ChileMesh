...
Compute the thickness of the slab (SLAB) and of the subduction channel (CH) at the end of the deformation process
...
# choose the measure the thickness of the channel (CH) or the slab (SLAB)
geom = 'CH'
# geom='SLAB'
...
# fig.savefig('./'+geom+'.png', format='png')
